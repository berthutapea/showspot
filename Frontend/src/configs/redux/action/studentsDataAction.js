...
export const CHANGE_STUDENT_PASSWORD_REQUEST = 'CHANGE_STUDENT_PASSWORD_REQUEST';
export const CHANGE_STUDENT_PASSWORD_SUCCESS = 'CHANGE_STUDENT_PASSWORD_SUCCESS';
export const CHANGE_STUDENT_PASSWORD_FAILURE = 'CHANGE_STUDENT_PASSWORD_FAILURE';
