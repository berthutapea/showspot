...
import { fetchShowcaseProjectsPendingMentors } from '../../../../../configs/redux/action/showcaseProjectsAction';

const ShowcaseProjectsPendingMentors = () => {
  ...
  useEffect(() => {
    dispatch(fetchShowcaseProjectsPendingMentors(currentPagePending));
...
export default ShowcaseProjectsPendingMentors;
