...
import { fetchShowcaseProjectsRejectedMentors } from '../../../../../configs/redux/action/showcaseProjectsAction';

const ShowcaseProjectsRejectedMentors = () => {
  ...
  useEffect(() => {
    dispatch(fetchShowcaseProjectsRejectedMentors(currentPageRejected));
            ...
            {Array.isArray(filteredProjects) && filteredProjects.length > 0 ? (
              filteredProjects.map((rejected, index) => (
                <tr key={rejected.application_id}>
                  ...
                  <td className="border-b border-[#eee] py-5 px-4 text-center dark:border-strokedark">
                    <Link
                      to={`/mentors/showcase-projects/rejected/view/${rejected.application_id}`}
                    >
...
export default ShowcaseProjectsRejectedMentors;
