    ...
    <div className="container mx-auto my-4 text-accent">
      <table className="w-full border-collapse rounded-lg">
        ...
        <tbody>
          ...
          generalShowcaseProjectsData.group_project ? (
            generalShowcaseProjectsData.group_project.map(
              (groupProject, index) => (
                <tr
...
export default ShowcaseMembersGeneral;
